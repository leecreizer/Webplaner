...
import { Wall, WallType, type SegmentInfoDraw } from '@/domain/structures/Wall';
...
import { getLineSegmentIntersection } from '@/lib/math/LineSegmentIntersection';
import { approximately, EPSILON } from '@/lib/math/Math';
